...
const CreateGalleryDetailsScreen = () => {
  ...
  const onContinue = async () => {
    ...
    try {
      const newGallery = await createGallery({
        galleryData: { name: name.trim(), type: 'GROUP', groupId: groupId || undefined },
        imageUri: imageUri ?? null,
      });
      navigation.navigate("ShareGallery", {
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            ...
            <View style={styles.fieldGroup}>
              <Text style={styles.fieldLabel}>Gallery name</Text>
              <TextInput
            ...
            <View style={styles.fieldGroup}>
              ...
              <TextInput
                ...
                placeholder="What's this gallery about? (Optional)"
                placeholderTextColor="#CCCCCC"
                multiline
                value={description}
...
export default CreateGalleryDetailsScreen;
