...
import { useApproveJoinRequest, useDenyOrRemoveMember } from "../../../../hooks/useMembershipData";
...
const PendingRequestsScreen = () => {
   ...
   const { pendingMembers, isLoading } = useMemberships(galleryId);
   const { mutate: approveMember, isPending: isApproving } = useApproveJoinRequest();
   const { mutate: denyMember, isPending: isDenying } = useDenyOrRemoveMember();
