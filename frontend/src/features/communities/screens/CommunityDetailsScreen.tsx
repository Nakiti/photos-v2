  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.title}>{(community as any)?.name ?? 'Community'}</Text>
        {!!(community as any)?.description && (
          <Text style={styles.desc}>{(community as any)?.description}</Text>
        )}
        <View style={styles.metaRow}>
          <Text style={styles.meta}>Owner • {(community as any)?.ownerId}</Text>
