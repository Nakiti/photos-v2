...
import { useCommunityMembers, useApproveCommunityJoinRequest, useRemoveCommunityMember } from "../../../../hooks/useCommunityMembershipData";
...
const PendingRequestsScreen = () => {
   ...
   const { pendingMembers, isLoading } = useCommunityMembers(communityId);
   const { mutate: approveMember, isPending: isApproving } = useApproveCommunityJoinRequest();
   const { mutate: denyMember, isPending: isDenying } = useRemoveCommunityMember();
